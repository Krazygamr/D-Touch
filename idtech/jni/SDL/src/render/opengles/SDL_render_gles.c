                   ...
                   const SDL_Rect * rect, const void *pixels, int pitch)
{
    ...
    //Need to do this for some devices otherwise black screen!!
...
extern int Android_ScreenWidth_Actual;
extern int Android_ScreenHeight_Actual;
static int
GLES_UpdateViewport(SDL_Renderer * renderer)
{
    ...
    //LOGI("GLES_UpdateViewport %d %d",Android_ScreenWidth_Actual, Android_ScreenHeight_Actual);

    data->glViewport(0, 0,Android_ScreenWidth_Actual, Android_ScreenHeight_Actual);
