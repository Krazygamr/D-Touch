...
#define JAVA_FUNC(x) Java_com_beloko_idtech_chocdoom_NativeLib_##x
...
void launchChocGame(int val)
{
	jclass helloWorldClass;
	jmethodID mainMethod;
	helloWorldClass = env_->FindClass("com/beloko/idtech/chocdoom/Setup");
...
void swapBuffers()
{
	if (NativeLibClass == 0)
	{
		NativeLibClass = env_->FindClass("com/beloko/idtech/chocdoom/NativeLib");
