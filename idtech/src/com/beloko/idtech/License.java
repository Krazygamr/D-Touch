...
public class License {
	...
	private static final int LIC_NETWORK_RETRIES = 5; //How many times to automatically retry license check
	private static final int LIC_MAX_UNLIC_CNT = 3; //Number of times it can run unlicened before quits 
	...
	public License(Context ctx,int game,String public_key)
	{
		this.ctx = ctx;
		this.game = game;
