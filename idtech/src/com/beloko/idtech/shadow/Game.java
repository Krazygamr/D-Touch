...
import com.beloko.idtech.prboom.Server.HelloThread;
...
implements Handler.Callback
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		doomPath  = getIntent().getStringExtra("game_path");
	...
	public void start_game() {
		...
		controlInterp = new QuakeControlInterpreter(engine,GD.IDGame.Doom,AppSettings.gamePadControlsFile,AppSettings.gamePadEnabled);
