package com.beloko.idtech.descent;
...
public class NativeLib implements QuakeControlInterface{
	...
	public static void loadLibraries(boolean setup)
	{
		...
		try {
			...
			SDLLib.loadSDL();
			System.loadLibrary("descent_main");
			System.loadLibrary("descent_android");
	...
	public  int mapKey(int acode,  int unicode)
	{
		...
		if ((acode >= KeyEvent.KEYCODE_1) && (acode <= KeyEvent.KEYCODE_9))
		{
			return SDL_SCANCODE_1 + (acode - KeyEvent.KEYCODE_1);
		}
		else if (acode == KeyEvent.KEYCODE_0)
		{
